...
public class MyController {
    ...
    public String adminEditUser(@RequestParam(required = false) String login,
    ...
    public String updateUser(@PathVariable(value = "login") String userLogin,
                             Model model) {
        CustomUser dbUser = userService.findByLogin(userLogin);
